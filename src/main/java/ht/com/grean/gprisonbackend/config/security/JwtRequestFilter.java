...
public class JwtRequestFilter extends OncePerRequestFilter
{
    ...
    private GestionPrisonUserDetailsService jwtUserDetailsService;

    private JwtTokenUtil jwtTokenUtil;

    public JwtRequestFilter (GestionPrisonUserDetailsService jwtUserDetailsService, JwtTokenUtil jwtTokenUtil) {
